...
import {mappingsDataFormat, stateDataFormat, suitableRequestFormat} from "./utils";
...
let sportEncodedStorage: Set<SportDataFormat>
let sportDecodedStorage: Set<SportDataFormat>
let decodedStorageConverter: RequestFormatConverter
let requestFormatStorage: Set<suitableRequestFormat>
...
responseStateExtractor = new ResponseStateExtractor(stateDataObj.odds)
sportEncodedStorage = responseStateExtractor.executeAndGetResult()
...
responseStateDecoder = new ResponseStateDecoder(sportEncodedStorage, mappingsDataObj.mappings)
sportDecodedStorage = responseStateDecoder.executeAndGetResult()

decodedStorageConverter = new RequestFormatConverter(sportDecodedStorage)
requestFormatStorage = decodedStorageConverter.executeAndGetResult()

import ResponseStateExtractor from "./api-response-handlers/ResponseStateExtractor";
import {SportDataFormat} from "./formats/SportDataFormat";
import ResponseStateDecoder from "./api-response-handlers/ResponseStateDecoder";
import RequestFormatConverter from "./RequestFormatConverter";
import {mappingsDataFormat, stateDataFormat, eventsDataRequestStorageFormat, sportEventsStorageFormat} from "./utils";
...
// let stateHandler = new ApiGetHandler('/api/state')
// let mappingsHandler = new ApiGetHandler('/api/mappings')
// let responseSender = new ApiPostHandler('/client/state')

let responseStateExtractor: ResponseStateExtractor
let responseStateDecoder: ResponseStateDecoder
